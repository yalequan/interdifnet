...
for (N in c(250, 500, 1000)) { # Sample Size
  for (m in c(2, 4)) { # Number of DIF Items
    for(r in 1:125){ # Number of data sets to generate
      ...
      save.image(file = paste0("Three_Group_Testing_Data_", N, "_", m*10, "_Replication_", r, ".RData"))
    }
  }
}
